...
import { deleteBom, getBom, getEventsForBom, updateBom } from '@/libs/api/bom'
...
const TP_ItemTabThirdParty = () => {
    ...
    async function handleDeleteBom(e) {
        setIsLoading(true)
        try {
    ...
    async function handleCloneBom(e) {
        // setIsLoading(true)
        // try {
        //     const response = await deleteBom(thirdPartyId);
        //     if (response.status !== 200) {
    ...
    async function handleValidateBom(e) {
        setIsLoading(true)
        try {
            const response = await updateBom({
                status: 1   // enable it
    ...
    async function handleDisableBom(e) {
        setIsLoading(true)
        try {
            const response = await updateBom({
                status: 9   // enable it
        ...
        <>
            <Grid item xs={12} display={'flex'} flexDirection={'column'} rowGap={8}>
                ...
                {thirdPartyData.status === 9 ? <Grid container justifyContent='flex-end' columnGap={4} alignItems='center'>
                    ...
                    <Button onClick={handleCloneBom} variant='contained' color='primary'>
                        Clone
                    </Button>
                    <Button onClick={handleDeleteBom} variant='contained' color='error'>
                        Delete
                    </Button>
                    ...
                    <Button onClick={handleCreateMo} variant='contained' color='primary'>
                        Create MO
                    </Button>
                    <Button onClick={handleCloneBom} variant='contained' color='primary'>
                        Clone
                    </Button>
                    <Button onClick={handleDisableBom} variant='contained' color='error'>
                        Disable
                    </Button>
                    <Button onClick={handleDeleteBom} variant='contained' color='error'>
                        Delete
                    ...
                    <Button onClick={handleValidateBom} variant='contained' color='primary'>
                        Validate
                    </Button>
                    <Button onClick={handleCloneBom} variant='contained' color='primary'>
                        Clone
                            ...
                            <Table>
                                <TableHead>
                                    <TableRow>
                                        ...
                                        <TableCell>Default workstation</TableCell>
