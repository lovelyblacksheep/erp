        ...
        <Grid item>
          ...
          >
            <Typography variant='h5' component='div'>
              Active subscriptions (targets/events) for automatic email notification
            </Typography>
          </Box>
        </Grid>
  ...
  return (
    <>
      <Grid item xs={12} display={'flex'} flexDirection={'column'} rowGap={8}>
        ...
        <ActiveSubNotiTp data={productLines} />
        <AutoEmailNotiTp data={productLines} />
      </Grid>
    </>
  )
}
