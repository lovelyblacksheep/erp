...
import { getThirdParties, getThirdParty } from '@/libs/api/third-parties'
...
const ModifyTpForm = () => {
  ...
  const handleSubmit = async () => {
    try {
      const result = await updateThirdParty(formData, params.id);
      if (result.success) {
        ...
        <Grid display={"flex"} flexDirection={"column"} gap={6} p={4} width={'100%'}>
          ...
          <Grid item xs={12} sm={9}>
            <TextField
              ...
              defaultValue={formData.name_alias}
          ...
          <Grid item xs={12} sm={6}>
            <TextField
              fullWidth
              label='Customer Code'
              defaultValue={formData.customer_code}
          ...
          <Grid item xs={12} sm={6}>
            <TextField
              fullWidth
              label='Vendor Code'
              defaultValue={formData.supplier_code}
              ...
              <Grid item xs={12} sm={6}>
                <FormControl fullWidth>
                  ...
                  <Select
                    ...
                    defaultValue={formData.default_lang}
              ...
              <Grid item xs={12} sm={3}>
                <FormControl fullWidth>
                  ...
                  <Select
                    ...
                    defaultValue={formData.no_email}
          ...
          <Grid item xs={12} sm={6}>
              ...
              <Grid item xs={12} sm={6}>
                <TextField
                  fullWidth
                  label='Snapchat'
                  defaultValue={formData.snapchat}
          ...
          <Grid item xs={12} sm={6}>
              ...
              <Grid item xs={12} sm={6}>
                <TextField
                  fullWidth
                  label='VAT ID'
                  defaultValue={formData.tva_intra}
              ...
              <Grid item xs={12} sm={6}>
                <FormControl fullWidth>
                  ...
                  <Select
                    ...
                    defaultValue={formData.typent_id}
              ...
              <Grid item xs={12} sm={6}>
                <FormControl fullWidth>
                  ...
                  <Select
                    label='Workforce'
                    defaultValue={formData.effectif_id}
              ...
              <Grid item xs={12} sm={6}>
                <FormControl fullWidth>
                  ...
                  <Select
                    ...
                    defaultValue={formData.forme_juridique_code}
            ...
            <Grid item xs={12} sm={6}>
                ...
                <div className='flex items-center gap-3 mt-2'>
                  <Select
                    label=''
                    defaultValue={formData.incoterm_id}
                  ...
                  <FormControl fullWidth>
                    <TextField
                      defaultValue={formData.location_incoterms}
              ...
              <Grid item xs={12} sm={11}>
                <FormControl fullWidth>
                  ...
                  <Select
                    ...
                    defaultValue={formData.custcats}
              ...
              <Grid item xs={12} sm={11}>
                <FormControl fullWidth>
                  ...
                  <Select
                    ...
                    defaultValue={formData.suppcats}
              ...
              <Grid item xs={12} sm={6}>
                <FormControl fullWidth>
                  ...
                  <Select
                    label='Currency'
                    defaultValue={formData.multicurrency_code}
              ...
              <Grid item xs={12} sm={8}>
                <FormControl fullWidth>
                  ...
                  <Select
                    ...
                    defaultValue={formData.parent_company_id}
                    onChange={e => setFormData({ ...formData, parent_company_id: e.target.value })}
                  >
                    {parentCompanies.map(parentCompany => (
                      <MenuItem defaultValue={parentCompany.id}>{parentCompany.name}</MenuItem>
                    ))}
                  </Select>
                </FormControl>
              </Grid>
              ...
              <Grid item xs={12} sm={11}>
                <FormControl fullWidth>
                  ...
                  <Select
                    ...
                    defaultValue={formData.commercial}
