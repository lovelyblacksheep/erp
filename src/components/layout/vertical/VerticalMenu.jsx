  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <MenuItem href={`/${locale}/dashboards/statistics`}>{"Statistics"}</MenuItem>
        ...
        <MenuItem
          ...
          href={`/${locale}`}
        // active={isActive('agenda-list')}
        // onClick={() => handleItemClick('agenda-list', `/${locale}`)}
        >
          Agenda
        </MenuItem>
        <MenuItem
          ...
          href={`/${locale}`}
        // active={isActive('projects-list')}
        // onClick={() => handleItemClick('projects-list', `/${locale}`)}
        >
          Projects
        </MenuItem>
        <MenuItem
          ...
          href={`/${locale}`}
        // active={isActive('hr-list')}
        // onClick={() => handleItemClick('hr-list', `/${locale}`)}
        >
          HR
        </MenuItem>
        <MenuItem
          ...
          href={`/${locale}`}
        // active={isActive('tasks-list')}
        // onClick={() => handleItemClick('tasks-list', `/${locale}`)}
        >
          Tasks
        </MenuItem>
        <MenuItem
          ...
          href={`/${locale}`}
        // active={isActive('accounting-list')}
        // onClick={() => handleItemClick('accounting-list', `/${locale}`)}
        >
          Accounting
        </MenuItem>
        <MenuItem
          ...
          href={`/${locale}`}
        // active={isActive('commerce-list')}
        // onClick={() => handleItemClick('commerce-list', `/${locale}`)}
        >
          Commerce
        </MenuItem>
        <MenuItem
          ...
          href={`/${locale}`}
        // active={isActive('wearhouse-list')}
        // onClick={() => handleItemClick('wearhouse-list', `/${locale}`)}
        >
          Wearhouse
        </MenuItem>
