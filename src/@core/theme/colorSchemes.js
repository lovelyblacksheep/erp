const colorSchemes = skin => {
  return {
    light: {
      palette: {
        primary: {
          main: '#FCC300', // Master color
          light: '#F7A823', // Master color
          dark: '#F08700', // Master color
          lighterOpacity: 'rgb(var(--mui-palette-primary-mainChannel) / 0.08)',
          lightOpacity: 'rgb(var(--mui-palette-primary-mainChannel) / 0.16)',
          mainOpacity: 'rgbx(var(--mui-palette-primary-mainChannel) / 0.24)',
          darkOpacity: 'rgb(var(--mui-palette-primary-mainChannel) / 0.32)',
          darkerOpacity: 'rgb(var(--mui-palette-primary-mainChannel) / 0.38)'
        },
        secondary: {
          main: '#ABABA7', // Secondary color
          light: '#717170', // Secondary color
          dark: '#575756', // Secondary color
          contrastText: '#FFF',
        ...
        warning: {
          main: '#EC6608', // Master color
          light: '#FDB528', // Adjusted to match other colors
          dark: '#E4A324',
          contrastText: '#FFF',
