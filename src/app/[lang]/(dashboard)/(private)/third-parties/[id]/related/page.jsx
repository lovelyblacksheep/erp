...
const ProjectsMappedToThisTp = ({ data }) => {
  ...
  return (
    <>
      <Grid item xs={12} display={'flex'} flexDirection={'column'} rowGap={8}>
        ...
        <Grid display={"flex"} justifyContent='flex-start' width={'100%'} flexDirection={"row"} columnGap={4} alignItems='center'>
          <Grid display={"flex"} justifyContent='flex-start' flexDirection={"row"} columnGap={4} alignItems='center'>
            <Typography>List of products/services mapped to</Typography>
          <Select></Select>
          </Grid>
          <Grid>
        ...
        <ProjectsMappedToThisTp data={productLines} />
      </Grid>
    </>
  )
}

export default TP_ItemTabRelated
