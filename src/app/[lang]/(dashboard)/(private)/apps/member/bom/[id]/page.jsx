...
// Component Imports
import UserLeftOverview from '@views/apps/member/bom/view/user-left-overview'
import UserRight from '@views/apps/member/bom/view/user-right'
...
const OverviewTab = dynamic(() => import('@views/apps/member/bom/view/user-right/third-party'))
const NetNeedsTab = dynamic(() => import('@views/apps/member/bom/view/user-right/net_needs/page'))
const NotesTab = dynamic(() => import('@views/apps/member/bom/view/user-right/notes/page'))
const LinkedFilesTab = dynamic(() => import('@views/apps/member/bom/view/user-right/linked_files/page'))
const EventsTab = dynamic(() => import('@views/apps/member/bom/view/user-right/events/page'))
...
const UserViewTab = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      // setData(pricingData)
      const response = await getBom(params.id)
